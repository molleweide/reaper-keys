...
return {
  ...
  InsertEmptyMeasures = "_S&M_INSERT_SILENCE_MB",
  InsertEmptySpaceFromTimeSelStart = 40200,
  ...
  SelectAllItemsInCurrentTimeSelectionOnSelTrk = 40718,
  ...
  SetModeVKB = lib.state.setModeVisualTrack,
  ...
  ToggleLastTouchedFxBypass = 40298,
  ToggleLocking = 1135,
  ToggleLoop = 1068,
  ...
  ToggleSelectedFxBypass = "_S&M_FXBYPSEL",
  ...
  VKBSendMidi_A_2 = lib.sendMidiNote_A_2,
  VKBSendMidi_Gs2 = lib.sendMidiNote_Gs2,
  VKBSendMidi_G_2 = lib.sendMidiNote_G_2,
  VKBSendMidi_Fs2 = lib.sendMidiNote_Fs2,
  VKBSendMidi_F_2 = lib.sendMidiNote_F_2,
  VKBSendMidi_E_2 = lib.sendMidiNote_E_2,
  VKBSendMidi_Ds2 = lib.sendMidiNote_Ds2,
  VKBSendMidi_D_2 = lib.sendMidiNote_D_2,
  VKBSendMidi_Cs2 = lib.sendMidiNote_Cs2,
  VKBSendMidi_C_2 = lib.sendMidiNote_C_2,
