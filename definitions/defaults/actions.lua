...
return {
  ...
  B_3 = lib.midi.sendMidiNote_B_3,
  As3 = lib.midi.sendMidiNote_As3,
  A_3 = lib.midi.sendMidiNote_A_3,
  Gs3 = lib.midi.sendMidiNote_Gs3,
  G_3 = lib.midi.sendMidiNote_G_3,
  Fs3 = lib.midi.sendMidiNote_Fs3,
  F_3 = lib.midi.sendMidiNote_F_3,
  E_3 = lib.midi.sendMidiNote_E_3,
  Ds3 = lib.midi.sendMidiNote_Ds3,
  D_3 = lib.midi.sendMidiNote_D_3,
  Cs3 = lib.midi.sendMidiNote_Cs3,
  C_3 = lib.midi.sendMidiNote_C_3,


  B_2 = lib.midi.sendMidiNote_B_2,
  As2 = lib.midi.sendMidiNote_As2,
  A_2 = lib.midi.sendMidiNote_A_2,
  Gs2 = lib.midi.sendMidiNote_Gs2,
  G_2 = lib.midi.sendMidiNote_G_2,
  Fs2 = lib.midi.sendMidiNote_Fs2,
  F_2 = lib.midi.sendMidiNote_F_2,
  E_2 = lib.midi.sendMidiNote_E_2,
  Ds2 = lib.midi.sendMidiNote_Ds2,
  D_2 = lib.midi.sendMidiNote_D_2,
  Cs2 = lib.midi.sendMidiNote_Cs2,
  C_2 = lib.midi.sendMidiNote_C_2,

  B_1 = lib.midi.sendMidiNote_B_1,
  As1 = lib.midi.sendMidiNote_As1,
  A_1 = lib.midi.sendMidiNote_A_1,
  Gs1 = lib.midi.sendMidiNote_Gs1,
  G_1 = lib.midi.sendMidiNote_G_1,
  Fs1 = lib.midi.sendMidiNote_Fs1,
  F_1 = lib.midi.sendMidiNote_F_1,
  E_1 = lib.midi.sendMidiNote_E_1,
  Ds1 = lib.midi.sendMidiNote_Ds1,
  D_1 = lib.midi.sendMidiNote_D_1,
  Cs1 = lib.midi.sendMidiNote_Cs1,
  C_1 = lib.midi.sendMidiNote_C_1,

  B_0 = lib.midi.sendMidiNote_B_0,
  As0 = lib.midi.sendMidiNote_As0,
  A_0 = lib.midi.sendMidiNote_A_0,
  Gs0 = lib.midi.sendMidiNote_Gs0,
  G_0 = lib.midi.sendMidiNote_G_0,
  Fs0 = lib.midi.sendMidiNote_Fs0,
  F_0 = lib.midi.sendMidiNote_F_0,
  E_0 = lib.midi.sendMidiNote_E_0,
  Ds0 = lib.midi.sendMidiNote_Ds0,
  D_0 = lib.midi.sendMidiNote_D_0,
  Cs0 = lib.midi.sendMidiNote_Cs0,
  C_0 = lib.midi.sendMidiNote_C_0,
