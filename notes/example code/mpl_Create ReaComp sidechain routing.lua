...
function main(threshold, ratio, defsendvol)
  ...
  -- increase chan
  --
  -- i should try without this part first
  --
  -- why is this. do i have to manully increate the number of channles??
    ...
    --
    --    create send to dest track
    --
    --      dest recieves into 3/4
    --
    --        compressor sidechains to selected track
    --
    --  the difference is that i can make a recieve from selected tracks
    --  with rlib. so that irecieve from all selected tracks. oooh, and this
    --  means that i can pretty much reuse this code exactly.
    ...
    for i = 1, #src_tr do
      if src_tr[i] ~= dest_trGUID then
        ...
        -- EVERYTHING BELOW ::::::::::::::::::::::::::::::::::::::::
        --
        -- all this can be done with rlib
        ...
        SetTrackSendInfo_Value( src_tr, 0, new_id, 'I_SENDMODE', 3) -- where in rlib
