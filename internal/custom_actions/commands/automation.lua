...
automation_actions.midi_cc_test = function()
  ...
  cp = reaper.MIDI_GetPPQPosFromProjTime(ctxm.take, cp)
  ...
  --       insert = {
  --           cc = {
  --               { cc = 1, ppqpos = cp, val = 50 },
  --               { cc = 2, ppqpos = cp + 100, val = 80 },
  --               { cc = 3, ppqpos = cp + 201, val = 100 },
  --               { cc = 20, ppqpos = cp, val = 100 },
  --               { cc = 20, ppqpos = cp + 50, val = 105 },
  --               { cc = 20, ppqpos = cp + 59, val = 100 },
  --               { cc = 20, ppqpos = cp + 66, val = 109 },
  --           },
  --       },
  --   })
  ...
  envelopes.midi_take_fltr_cc({
    take = ctxm.take,
    insert = {
      pitch = { { ppqpos = ms, val = 0, shape = "linear" }, { ppqpos = me - 10, val = pb_step * 8 } },
    },
  })
