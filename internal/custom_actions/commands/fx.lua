...
-- NOTE: All of this can be replaced with the file browsers internal file
  ...
  --          programmatically preview the sounds.
    ...
    -- NOTE: This is the new picker browser.
    --
    -- restrict to this dir "/Users/hjalmarjakobsson/reaper/samples/1Shots Sampler Inst"
    --
    -- pickers.file_browser({
    --     cwd = sample_dir_path,
    --
    --     on_select_files = function() end,
  --
  --     -- i dont need to impl this...
    --     on_select_dirs = function() end,
    --     on_exit = function()
    --     restore_sample()
    --     end
    -- })
