...
--
-- HACK: This will require yet another fltr func for track objects.
commands.picker_copy_sel_tracks_items_from_current_region_to_next_region = function()
  ...
  pickers.all_tracks(_, {
    width = 900,
    filter = function(o)
      return s.strHasOneOfChars(o.class, "MCS") and
        lib_tr.has_items_within_timeline_range(o, find_region.pos, find_region.rgnend)
    end,
		on_select_func = function()
		  log.user("<CR> in [picker copy sel tr items to next region]: Now i need to actually copy the information.")
