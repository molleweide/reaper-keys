...
commands.picker__midi_source_manager = function()
    ...
    pickers.all_tracks(
      ...
      tbl.deep_extend({
        ...
        extended_mappings = {
          ...
          -- RESET SELECTION
          --
          -- if every mapping was a table instead, then
          ...
          --
          -- SHOW ONLY TRACKS FROM SELECTED GROUP/TRACKS GROUP
          --
          -- RND: Investigate how I can batch enable/disable specific groups/zones..
          --
          ["C-g"] = function(t)
...
commands.apply_curve_to_prev_inserted_notes = function()
  log.clear()
