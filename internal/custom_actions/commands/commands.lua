...
commands.picker_media_item_info_params = function()
  ...
  -- for track/item/etc...
    fzf.init({
        title = string.format("Track Info Params for track = (%s) %s", item._parent.tracknumber, item._parent.name),
        x = 0,
        width = 600,
        height = 700,
        results = arr,
...
commands.picker_media_item_take_info_params = function() end
