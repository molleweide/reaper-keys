...
-- IIRC there was some quirk with this; I am not sure how to get the underlying
-- plugin name and so i am just matching against my syntax stringx but this
-- should probably be the exact plugin name string. the real VST name string.
...
rs5k.updateSample = function(tobj, fx_idx, wav_file_path)
    ...
    sample name = %s
            ...
            tobj.name,
            tobj.name_components[1],
            path.get_basename_without_extension(wav_file_path)
        ))
