...
track_info.get_track_info_params = function(track)
    local t_track_info = {
        ...
        D_PANLAW = {
            type = "double",
            name = "D_PANLAW",
            description = "pan law of track, <0=project default, 0.5=-6dB, 0.707..=-3dB, 1=+0dB, 1.414..=-3dB with gain compensation, 2=-6dB with gain compensation, etc",
        },
        I_PANLAW_FLAGS = {
            type = "int",
            name = "I_PANLAW_FLAGS",
            description = "pan law flags, 0=sine taper, 1=hybrid taper with deprecated behavior when gain compensation enabled, 2=linear taper, 3=hybrid taper",
        },
        P_ENV = {
            type = "TrackEnvelope *",
            read_only = true,
