...
local sx_utils = require("sx.utils")
...
--     local g_obj, g_tr, _ = sx_utils.get_track_object_group(sx.getVerifiedTree(track_objects_list), tobj.trackIndex)
--     local fx_idx
--     if target_fx_idx then
--       fx_idx = target_fx_idx
--     else
--       local t_fx_by_name = lib_fx.get_fx_objs_by_name_string(tobj.guid_tr, "ReaSamplomatic")
