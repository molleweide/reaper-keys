...
local T_MEDIA_ITEM_INFO_PARAMS = {
  B_MUTE = {
    type = "bool",
    name = "B_MUTE",
    description = "bool * : muted (item solo overrides). Setting this value will _clear_ C_MUTE_SOLO.",
  },
  B_MUTE_ACTUAL = {
    type = "bool",
    name = "B_MUTE_ACTUAL",
    description = "bool * : muted (ignores solo). setting this value will not affect C_MUTE_SOLO.",
  },
  ...
  C_MUTE_SOLO = {
    type = "bool",
    name = "C_MUTE_SOLO",
    description = [[char * : solo override (-1=soloed, 0=no override, 1=unsoloed). note that
    this API does not automatically unsolo other items when soloing (nor clear
    the unsolos when clearing the last soloed item), it must be done by the
    caller via action or via this API.]],
  },
  B_LOOPSRC = {
    type = "B_LOOPSRC",
    name = "B_LOOPSRC",
    description = "Loop item source",
  },
  ...
  C_BEATATTACHMODE = {
    ...
    description = [[char * : item timebase, -1=track or project default, 1=beats (position,
  ...
  D_VOL = {
    type = "double",
    name = "D_VOL",
    description = [[double * : item volume, 0=-inf, 0.5=-6dB, 1=+0dB, 2=+6dB, etc]],
  },
  ...
  I_CUSTOMCOLOR = {
    type = "int",
    name = "I_CUSTOMCOLOR",
    description = [[int * : custom color, OS dependent color|0x1000000 (i.e.
    ColorToNative(r,g,b)|0x1000000). If you do not |0x1000000, then it will not
    be used, but will store the color]],
  },
